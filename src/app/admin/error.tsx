...
export default function AdminError({ reset }: AdminErrorProps) {
  return (
    <div role="alert" className="flex flex-col items-center gap-4 px-6 py-16 text-center">
      <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-red-500">Something went wrong</p>
      <h1 className="text-2xl font-semibold text-gray-900">We couldn&apos;t load this page</h1>
