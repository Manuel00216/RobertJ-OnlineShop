...
/** Topbar for the Admin Portal — ported from the Figma design, driven entirely by semantic tokens so it repaints with the active theme. */
          ...
          {showProfile && (
            <div className="absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-xl border border-border bg-card shadow-lg">
              <div className="border-b border-border px-4 py-3">
                <p className="text-sm font-semibold text-foreground">{user.fullName ?? "Administrator"}</p>
